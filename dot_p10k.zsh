# Generated by Powerlevel10k configuration wizard on 2022-06-30 at 20:51 AEST.
...
() {
  ...
  #   # Wifi colors and icons for different signal strength levels (low to high).
     typeset -g my_wifi_fg=(9 214 11 49 10)                                # <-- change these values
  #   typeset -g my_wifi_icon=('WiFi' 'WiFi' 'WiFi' 'WiFi' 'WiFi')     # <-- change these values
  #
  #   typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}$P9K_WIFI_LAST_TX_RATE Mbps $P9K_WIFI_SSID'
  typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}$P9K_WIFI_SSID'
